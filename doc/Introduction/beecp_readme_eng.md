...
| Item                                                                | HikariCP                                 | BeeCP                                      |
|-------------------------------------------------------------------  |------------------------------------------|-------------------------------------------- |
| Connections cached in threadlocal                                   | >=1 (List)                               | =1                                          |
| Type of container to store connections                              | CopyOnWriteArrayList                     | An array of fixed length                    |
| Type of queue for waiting(/transfer)                                | SynchronousQueue                         | ConcurrentLinkedQueue                       |
| Type of async mode to create connections                            | Thread pool                              | Single thread                               |
| Supports concurrency creation of connections                        | Not Support                              | Support                                     |
| Supports pool restarting                                            | Not Support                              | Support                                     |
| Provides interrupts methods for pool blocking                       | Not Provide                              | Provide                                     |
| Provides interfaces to be extended                                  | Only exceptionOverride                   | Six                                         |
| Provides configuration of exception code and sql state              | Not Provides                             | Provide                                     |
| Provides configuration flag to enable/disable  threadLocal-cache    | Not Provides                             | Support                                     |
| Support XADataSource                                                | Not Provides                             | Support                                     |
| Provides switch method to enable or disable runtime logs print      | Not Provides                             | Support                                     |
| Support force reset on schema,catalog (transaction)                 | Not Provides                             | Support                                     |
| Support reading default from first connection                       | Not Support                              | Support                                     |
