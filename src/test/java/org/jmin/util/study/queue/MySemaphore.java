 ...
 */
package org.jmin.util.study.queue;
...
public class MySemaphore {
     ...
     *
     * @param timeout the maximum time to wait for a synchronizer
     * @param unit    the time unit of the {@code timeout} argument
     * @return {@code true} if a synchronizer was acquired and {@code false}
     * if the waiting time elapsed before a synchronizer was acquired
