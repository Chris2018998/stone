...
import org.jmin.beecp.pool.ConnectionPoolStatics;
...
public class PropertiesFileLoadTest extends TestCase {
    ...
    private final String ConfigDriver = "org.jmin.beecp.mock.MockDriver";
...
//        if (testConfig.getBorrowSemaphoreSize() != 4)return"borrowSemaphoreSize error");
        ...
        if (!"org.jmin.beecp.pool.ConnectionFactoryByDriver".equals(testConfig.getConnectionFactoryClassName()))
            return "connectionFactoryClassName error";
        if (!"org.jmin.beecp.pool.RawConnectionPool".equals(testConfig.getPoolImplementClassName()))
