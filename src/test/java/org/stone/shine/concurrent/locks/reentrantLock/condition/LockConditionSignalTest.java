 ...
 */
package org.stone.shine.concurrent.locks.reentrantLock.condition;

import org.stone.shine.concurrent.locks.condition.AwaitThread;
 ...
 * @version 1.0
 */
public class LockConditionSignalTest extends TestCase {
    ...
    public void test() throws Exception {
        ...
        AwaitThread conditionWaitThread = new AwaitThread(lock, condition, "await");
