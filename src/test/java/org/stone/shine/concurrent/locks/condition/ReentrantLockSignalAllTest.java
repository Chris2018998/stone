...
//        ReentrantLockConditionAwaitThread conditionWaitThread1 = new ReentrantLockConditionAwaitThread(lock, condition, "await");
//        conditionWaitThread1.start();
//        ReentrantLockConditionAwaitThread conditionWaitThread2 = new ReentrantLockConditionAwaitThread(lock, condition, "await");
