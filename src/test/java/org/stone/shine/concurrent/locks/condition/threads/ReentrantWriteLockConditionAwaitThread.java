...
public class ReentrantWriteLockConditionAwaitThread extends BaseThread {
    ...
    public ReentrantWriteLockConditionAwaitThread(ReentrantReadWriteLock lock, Condition condition, String methodName) {
        super(condition, methodName);
        this.lock = lock;
    }

    public ReentrantWriteLockConditionAwaitThread(ReentrantReadWriteLock lock, Condition condition, String methodName, Date deadline) {
        super(condition, methodName);
        this.deadline = deadline;
        this.lock = lock;
    }

    public ReentrantWriteLockConditionAwaitThread(ReentrantReadWriteLock lock, Condition condition, String methodName, long timeout, TimeUnit timeUnit) {
