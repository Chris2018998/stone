...
public class GeneralAwaitThread extends BaseThread {
    ...
    public GeneralAwaitThread(CountDownLatch latch, String methodName) {
        super(latch, methodName);
    }

    public GeneralAwaitThread(CountDownLatch latch, String methodName, long timeout, TimeUnit timeUnit) {
