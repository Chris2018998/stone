 ...
 * @version 1.0
 */
abstract class BaseThread extends ConcurrentMockThread {

    protected CountDownLatch latch;

    BaseThread(CountDownLatch latch) {
        this.latch = latch;
    }

    BaseThread(CountDownLatch latch, String methodName) {
        super(methodName);
        this.latch = latch;
    }

    BaseThread(CountDownLatch latch, String methodName, long timeout, TimeUnit timeUnit) {
