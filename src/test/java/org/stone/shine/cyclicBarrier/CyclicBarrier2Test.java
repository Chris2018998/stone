...
// */
//package org.stone.stone.cyclicBarrier;
//
//import org.stone.stone.concurrent.CyclicBarrier2;
//
...
//        PassengerThread[] threads = new PassengerThread[count];
//        for (int i = 0; i < count; i++) {
//            threads[i] = new PassengerThread(barrier);
//            threads[i].start();
//        }
//
//        for (int i = 0; i < count; i++) {
//            threads[i].join();
//            System.out.println("threads[" + i + "] is end");
//        }
//
