...
import org.stone.study.shine.util.concurrent.synchronizer.ResourceAction;
...
import static org.stone.study.shine.util.concurrent.synchronizer.SyncConstants.BASE_VISIT_TESTER;
import static org.stone.study.shine.util.concurrent.synchronizer.SyncConstants.INT_ONE;
...
public class Semaphore {
    ...
    public Semaphore(int permits, boolean fair) {
        ...
        this.permitAction = new PermitAcquireAction(permitSize);
    }
    ...
    public boolean tryAcquire(int permits) {
        if (permits <= 0) throw new IllegalArgumentException();
        return permitAction.tryAcquire(permits);
    }
    ...
    public void release(int permits) {
        ...
        if (permitAction.tryRelease(permits)) waitPool.wakeupFirst();
    }
