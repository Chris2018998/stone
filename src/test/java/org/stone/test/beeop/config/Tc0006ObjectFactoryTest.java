...
public class Tc0006ObjectFactoryTest {
    ...
    public void testOnAddProperty() {
        ...
        Assertions.assertNull(config.getFactoryProperty(null));
        config.addFactoryProperty(null, "value");
        Assertions.assertNull(config.getFactoryProperty(null));
        config.addFactoryProperty("key", null);
        Assertions.assertNull(config.getFactoryProperty(null));
        config.addFactoryProperty("key", "value");
        Assertions.assertNotNull(config.getFactoryProperty("key"));
    }
    ...
    public void testOnRemoval() {
        ...
        Assertions.assertEquals("value1", config.getFactoryProperty("prop1"));
        Assertions.assertEquals("value1", config.removeFactoryProperty("prop1"));
        Assertions.assertNull(config.getFactoryProperty("prop1"));
    }
    ...
    public void testOnAddTextProperty1() {
        ...
        Assertions.assertEquals("value1", config.getFactoryProperty("prop1"));
        Assertions.assertEquals("value2", config.getFactoryProperty("prop2"));
        Assertions.assertEquals("value3", config.getFactoryProperty("prop3"));
    }
    ...
    public void testOnAddTextProperty2() {
        ...
        Assertions.assertEquals("value2", config.getFactoryProperty("prop2"));
        Assertions.assertEquals("value3", config.getFactoryProperty("prop3"));
        Assertions.assertNull(config.getFactoryProperty("prop4"));
    }
    ...
    public void testLoadFromProperties() {
        ...
        Assertions.assertEquals("value1", config1.getFactoryProperty("prop1"));
        Assertions.assertEquals("value2", config1.getFactoryProperty("prop2"));
        Assertions.assertEquals("value3", config1.getFactoryProperty("prop3"));
        ...
        Assertions.assertEquals("value1", config2.getFactoryProperty("prop1"));
        Assertions.assertEquals("value2", config2.getFactoryProperty("prop2"));
        Assertions.assertEquals("value3", config2.getFactoryProperty("prop3"));
        ...
        Assertions.assertEquals("value1", config3.getFactoryProperty("prop1"));
        Assertions.assertEquals("value2", config3.getFactoryProperty("prop2"));
        Assertions.assertEquals("value3", config3.getFactoryProperty("prop3"));
    }
    ...
    public void testFactoryCreation() throws Exception {
        ...
        Assertions.assertTrue(((Map<?, ?>) TestUtil.getFieldValue(config2, "factoryProperties")).isEmpty());

        config = OsConfigFactory.createDefault();
        config.addFactoryProperty("name", "Java");
        config2 = config.check();
        Assertions.assertNotNull(config2.getObjectFactory());
        Assertions.assertFalse(((Map<?, ?>) TestUtil.getFieldValue(config2, "factoryProperties")).isEmpty());
