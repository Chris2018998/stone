 ...
 */
package org.stone.test.shine.concurrent.locks.condition.threads;
...
public class ReentrantWriteLockConditionAwaitThread extends BaseThread {
    ...
    public ReentrantWriteLockConditionAwaitThread(Lock lock, Condition condition, String methodName) {
        super(condition, methodName);
        this.lock = lock;
    }

    public ReentrantWriteLockConditionAwaitThread(Lock lock, Condition condition, String methodName, Date deadline) {
        super(condition, methodName);
        this.deadline = deadline;
        this.lock = lock;
    }

    public ReentrantWriteLockConditionAwaitThread(Lock lock, Condition condition, String methodName, long timeout, TimeUnit timeUnit) {
    ...
    public void run() {
        ...
        try {
            ...
            this.locked2 = (Boolean) TestUtil.invokeMethod(lock, "isHeldByCurrentThread");
            lock.unlock();
        }
    }
}
