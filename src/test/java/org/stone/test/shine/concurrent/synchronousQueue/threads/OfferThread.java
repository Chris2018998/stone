 ...
 */
package org.stone.test.shine.concurrent.synchronousQueue.threads;
...
public class OfferThread extends BaseThread {
    ...
    public OfferThread(SynchronousQueue queue, String methodName, Object offerObject, long timeout, TimeUnit timeUnit) {
