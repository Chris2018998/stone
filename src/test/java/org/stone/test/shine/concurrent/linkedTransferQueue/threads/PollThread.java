 ...
 */
package org.stone.test.shine.concurrent.linkedTransferQueue.threads;

import org.stone.study.shine.util.concurrent.LinkedTransferQueue;
...
public class PollThread extends BaseThread {
    ...
    public PollThread(LinkedTransferQueue queue, String methodName) {
        super(queue, methodName);
    }

    public PollThread(LinkedTransferQueue queue, String methodName, long timeout, TimeUnit timeUnit) {
