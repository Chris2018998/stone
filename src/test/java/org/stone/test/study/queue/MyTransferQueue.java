...
public final class MyTransferQueue<E> extends ConcurrentLinkedQueue<E> {
    ...
    //nanoSecond,spin min parkTime value
     ...
     * if not exists,then waiting for a transferred element by method:{@code offer}
     *
     ...
     * specified waiting parkTime elapses before an element is available
