...
//        testWriteAndRead("LinkedBlockingQueue2", new LinkedBlockingQueue2<Object>(), threadSize, takeTimes);
...
//        testWriteAndRead("BeeTransferQueue", new BeeTransferQueue<Object>(), threadSize, takeTimes);
        ...
        testWriteAndRead("MyTransferQueue", new MyTransferQueue<Object>(), threadSize, takeTimes);
    }
