...
import org.stone.test.beetp.join.ArraySumComputeTask;
import org.stone.test.beetp.join.ArraySumJoinOperator;
...
//    }
    ...
    public static void setup(BenchmarkParams params) {
        ...
        config.setMaxOnceTaskSize(1000);
        config.setOnceWorkerKeepAliveTime(TimeUnit.SECONDS.toMillis(15));
