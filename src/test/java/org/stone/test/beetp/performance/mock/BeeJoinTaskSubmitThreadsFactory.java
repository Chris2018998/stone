...
import org.stone.test.beetp.performance.BeeJoinTask;
import org.stone.test.beetp.performance.BeeJoinTaskOpr;
...
public class BeeJoinTaskSubmitThreadsFactory implements TimeMonitorTaskThreadsFactory {
    ...
    public TimeMonitorTaskSubmitThread[] create(TimeMonitorTaskPoolInitConfig config) {
        ...
        serverConfig.setMaxOnceTaskSize(config.getMaxTaskSize());
        serverConfig.setOnceWorkerKeepAliveTime(config.getKeepAliveTimeUnit().toMillis(15));
