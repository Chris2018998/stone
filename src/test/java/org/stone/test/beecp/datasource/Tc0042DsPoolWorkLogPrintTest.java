 ...
 * @author Chris Liao
 */
public class Tc0042DsPoolWorkLogPrintTest {

    @Test
    public void testUpdateToConfig() throws SQLException {
        try (BeeDataSource ds = new BeeDataSource()) {
            Assertions.assertFalse(ds.isPrintRuntimeLog());
            ds.setPrintRuntimeLog(true);
            Assertions.assertTrue(ds.isPrintRuntimeLog());
