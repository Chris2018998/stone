...
public class Tc0043ConnectionGetLogCollectTest {
    ...
    public void testEnableAndDisableLogCollector() throws SQLException {
        ...
        config2.setJdbcCallLogManager(new DefaultJdbcLogManager());
        ...
        config3.setJdbcCallLogManagerClass(DefaultJdbcLogManager.class);
        ...
        config4.setJdbcCallLogManagerClassName(DefaultJdbcLogManager.class.getName());
