...
//import org.stone.beecp.pool.exception.ConnectionDefaultValueSetException;
...
//            Assertions.assertInstanceOf(ConnectionDefaultValueSetException.class, e.getCause());
//        }
//
...
//        Assertions.assertTrue(logs.contains("Failed to get default value of 'auto-commit' from initial test connection"));
//        Assertions.assertTrue(logs.contains("Failed to get default value of 'transaction-isolation' from initial test connection"));
//        Assertions.assertTrue(logs.contains("Failed to get default value of 'read-only' from initial test connection"));
//        Assertions.assertTrue(logs.contains("Failed to get default value of 'catalog' from initial test connection"));
//        Assertions.assertTrue(logs.contains("Failed to get default value of 'schema' from initial test connection"));
//
//        //not print logs
...
//        Assertions.assertFalse(logs.contains("Failed to get default value of 'auto-commit' from initial test connection"));
//        Assertions.assertFalse(logs.contains("Failed to get default value of 'transaction-isolation' from initial test connection"));
//        Assertions.assertFalse(logs.contains("Failed to get default value of 'read-only' from initial test connection"));
//        Assertions.assertFalse(logs.contains("Failed to get default value of 'catalog' from initial test connection"));
//        Assertions.assertFalse(logs.contains("Failed to get default value of 'schema' from initial test connection"));
//    }
//
//    //@Test
