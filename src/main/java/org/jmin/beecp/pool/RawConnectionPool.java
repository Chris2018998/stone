...
public final class RawConnectionPool implements ConnectionPool, ConnectionPoolJmxBean {
    ...
    private void registerJMX() {
        if (poolConfig.isEnableJmx()) {
            ...
            try {
                final ObjectName poolRegName = new ObjectName("org.jmin.beecp.pool.RawConnectionPool:type=BeeCP(" + poolName + ")");
            ...
            try {
                final ObjectName configRegName = new ObjectName("org.jmin.beecp.BeeDataSourceConfig:type=BeeCP(" + poolName + ")-config");
