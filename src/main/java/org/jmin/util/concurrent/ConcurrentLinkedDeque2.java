 ...
 */
package org.jmin.util.concurrent;
 ...
 * @version 1.0
 */
public class ConcurrentLinkedDeque2<E> extends AbstractCollection<E> implements Deque<E>, java.io.Serializable {
    //***************************************************************************************************************//
    //                                           1: CAS Chain info                                                   //
    //***************************************************************************************************************//
    ...
    public ConcurrentLinkedDeque2() {
        head.next = tail;
        tail.prev = head;
    }

    public ConcurrentLinkedDeque2(Collection<? extends E> c) {
        head.next = tail;
        tail.prev = head;
