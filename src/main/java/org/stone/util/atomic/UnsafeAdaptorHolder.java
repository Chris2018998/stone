...
public final class UnsafeAdaptorHolder {
    ...
    private static final String SunMiscUnsafeAdaptorImplClass = "org.stone.util.atomic.UnsafeAdaptorSunMiscImpl";//low version
    private static final String JdkMiscUnsafeAdaptorImplClass = "org.stone.util.atomic.UnsafeAdaptorJdkMiscImpl";//high version
