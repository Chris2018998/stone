...
public final class TaskExecutionPool implements BeeTaskPool {
    ...
    private ConcurrentLinkedQueue<GenericTaskHandle> taskQueue;
    ...
    //***************************************************************************************************************//
    void removeExecuteTask(AbstractTaskHandle handle) {
    ...
    public BeeTaskHandle submit(BeeTask task) throws BeeTaskException, BeeTaskPoolException {
        ...
        GenericTaskHandle taskHandle = new GenericTaskHandle(task, offerInd ? TASK_NEW : TASK_CANCELLED, this);
    ...
    private void offerToTaskQueue(GenericTaskHandle taskHandle) {
...
//            }
    ...
    private static class TaskRemoveOldestPolicy implements TaskRejectPolicy {
        public boolean rejectTask(BeeTask task, TaskExecutionPool pool) {
            GenericTaskHandle oldTask = pool.taskQueue.poll();
            if (oldTask != null) {
