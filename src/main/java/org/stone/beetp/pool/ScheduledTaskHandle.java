 ...
 * @version 1.0
 */
public class ScheduledTaskHandle extends AbstractTaskHandle {
    private long executeTimePoint;
    private long delayNanoseconds;
    private boolean delayFromExecuteTime;

    ScheduledTaskHandle(BeeTask task, int initState, BeeTaskCallback callback, TaskExecutionPool pool) {
