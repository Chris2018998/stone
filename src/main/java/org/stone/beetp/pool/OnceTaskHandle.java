 ...
 * @version 1.0
 */
public class OnceTaskHandle extends BaseHandle {
    protected final AtomicInteger curState;//reset to waiting state after execution when current task is periodic
    ...
    //                1: constructor(1)                                                                              //
    //***************************************************************************************************************//
    public OnceTaskHandle(BeeTask task, BeeTaskCallback callback, TaskPoolImplement pool, TaskExecFactory factory) {
        super(factory);
        this.task = task;
        this.pool = pool;
