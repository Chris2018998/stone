...
public class GenericTaskHandle implements BeeTaskHandle {
    ...
    protected Object curResult;//can be reset to be null(initialization state)
    protected AtomicInteger curState;//can be reset to be waiting(initialization state)
