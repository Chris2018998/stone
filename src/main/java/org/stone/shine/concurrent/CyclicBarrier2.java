...
// */
//package org.stone.stone.concurrent;
//
//import org.stone.stone.synchronizer.CompleteWaitPool;
//
...
// * boarding during a parkTime period,some passengers be loss of patience and exit this trip,wakeup automatically some
...
// */
//
//public final class CyclicBarrier2 extends CompleteWaitPool {
...
//    }
//
//    //count reach seatSize,which means all programs over
...
//                wakeup(flightNo);//wakeup other passengers in room(sleeping)
...
//                this.wakeup(0);//wakeup hall passengers to buy ticket of next trip
//
//                return seatNo;
////                } else {
////                    if (flightState.get() == State_Boarding && flightState.compareAndSet(State_Boarding, State_Cancelled))
////                        this.wakeup(0);//notify hall passengers that the flight has cancelled
////                    throw new BrokenBarrierException();
////                }
//            }
//
...
//                super.get(seatNo > 0 ? flightNo : 0, timeout, unit);
//                if (seatNo > 0) {
