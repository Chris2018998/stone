...
public class ThreadTaskResultFuture<V> implements Future<V> {
    //task in executing
    ...
    private final Object taskHolder;//@todo to be dev
    ...
    ThreadTaskResultFuture(ThreadPoolExecutor executor, Object taskHolder) {
    ...
    public boolean cancel(boolean mayInterruptIfRunning) {
        if (executor.cancelTask(futureId, mayInterruptIfRunning)) {
