 ...
 * @since 1.5
 */
public class SynchronousQueue3<E> extends AbstractQueue<E>
     ...
     *  2. SynchronousQueue2s must block threads waiting to become
     *     fulfilled.
     ...
     */
    public SynchronousQueue3(boolean fair) {
    ...
    private static final class TransferQueue<E> extends Transferer<E> {
        ...
        private TransferQueue() {
            Node h = new Node(null); // initialize to dummy node.
            head = h;
            tail = h;
        }

        void casHead(Node h, Node nh) {
            if (h == head) UNSAFE.compareAndSwapObject(this, headOffset, h, nh);
        }

        void casTail(Node t, Node nt) {
        ...
        public E tryMatch(Node<E> s) {
            ...
            if (current == null) return matchedItem;
        ...
        private static final class Node<E> {
            ...
            private boolean casMatch(Node val) {
                return match == null &&
                        UNSAFE.compareAndSwapObject(this, matchOffset, null, val);
            }
        }


        //        public E tryMatch2(Node<E> s) {
//
//            do {
//                Node<E> m = head.next;
...
//
//                try {
//                    if (m.match == null && m.casMatch(s)) {
//                        LockSupport.unpark(m.waiter);
//                        return s.isData ? s.item : m.item;
//                    }
//                } finally {
//                    casHead(head, m);
//                }
