 ...
 * @version 1.0
 */
public final class ShareCallTester extends ResultCallTest {
    public static final ResultCallTest Tester = new ShareCallTester();

    private ShareCallTester() {
    }

    //true,result call will be execute in pool
    public final boolean canCall(boolean fair, SyncNode firstNode, SyncVisitConfig config) {
