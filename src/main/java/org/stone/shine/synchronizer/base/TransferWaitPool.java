...
public final class TransferWaitPool<E> extends ThreadWaitPool {
    ...
    public final boolean offer(E e, ThreadParkSupport parker, boolean throwsIE) {
        try {
    ...
    public final boolean transfer(E e, ThreadParkSupport parker, boolean throwsIE) throws InterruptedException {
        ...
        ThreadNode node = createWaitNode(Node_Type_Data);
        node.setValue(e);
    ...
    public final E get(ThreadParkSupport parker, boolean throwsIE) throws InterruptedException {
        ...
        //step2:create wait node(then to wait)
        ThreadNode node = createWaitNode(Node_Type_Get);
