...
class ThreadNodeChain {
    protected transient volatile ThreadNode head = new ThreadNode(null, null, false);
    protected transient volatile ThreadNode tail = new ThreadNode(null, null, false);
