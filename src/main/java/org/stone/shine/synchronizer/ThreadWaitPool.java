...
public abstract class ThreadWaitPool {
    ...
    //                                          2: queue Methods(8)                                                   //
    //****************************************************************************************************************//
    protected static ThreadNode createWaitNode() {
        return createWaitNode(null);
    }

    protected static ThreadNode createWaitNode(Object type) {
        return new ThreadNode(type);
    }

    protected static ThreadNode createDataNode(Object type, Object value) {
